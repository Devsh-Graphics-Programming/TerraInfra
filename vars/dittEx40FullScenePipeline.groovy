          ...
          if (isolateScenes) {
            ...
            stage('Prepare isolated render') {
              ...
              writeFile file: 'merge-isolated-report.ps1', text: [
                ...
                '  if ((Test-Path -LiteralPath $summaryCopy) -and -not $hasNonZeroExit) {',
                ...
                '    $reason = if (Test-Path -LiteralPath $timeoutPath) { "EX40 exceeded Jenkins scene timeout before writing summary.json." } elseif ($hasNonZeroExit) { "EX40 exited with code " + $exitText + "." } elseif (Test-Path -LiteralPath $exitPath) { "EX40 exited without reportable results." } else { "EX40 did not write summary.json." }',
